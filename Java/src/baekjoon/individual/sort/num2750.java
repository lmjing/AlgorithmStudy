package baekjoon.individual.sort;
...
public class num2750 {
    public static void main(String[] args){
        ...
        System.out.println("bubble baekjoon.individual.sort 결과");
        easy.print_array(array);

        array=original;
        easy.select_sort(array);
        System.out.println("select baekjoon.individual.sort 결과");
        easy.print_array(array);

        array=original;
        easy.insert_sort(array);
        System.out.println("insert baekjoon.individual.sort 결과");
        easy.print_array(array);
    }
}
